        ...
        while importer_state != "END":
            ...
            if importer_state == "READ_MESH":
                ...
                if version in (4, 5):
                    ...
                    indices_num = read_uint_16(file_aem)
                    faces = read_short_triplets_array(file_aem, indices_num)
                    v_num = read_uint_16(file_aem)
            ...
            if importer_state == "BUILD_MESH":
                ...
                mesh.update()
                mesh.validate()  # needed to prevent segfaults due to invalid meshes (thynome, kothar and some other stations)
                if uvs_present:
